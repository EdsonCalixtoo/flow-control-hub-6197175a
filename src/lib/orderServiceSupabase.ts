...
const BASIC_ORDER_COLUMNS = 'id, number, client_id, client_name, seller_id, seller_name, subtotal, taxes, total, status, notes, observation, order_type, is_cronograma, financeiro_aprovado, is_warranty, status_pagamento, status_producao, created_at, updated_at, requires_invoice, requires_shipping_note, delivery_date, installation_date, scheduled_date, installation_time, carrier, volumes, payment_method, comprovantes_vistos, items, receipt_urls, receipt_url, parent_order_id, parent_order_number';
