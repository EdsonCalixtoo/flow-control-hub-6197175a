...
import type { Warranty, WarrantyStatus } from '@/types/erp';
...
const WarrantyTrackingPage: React.FC = () => {
    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6 text-center">
                ...
                <p className="text-slate-500 font-medium animate-pulse">Consultando assistência técnica...</p>
            </div>
        );
    }
    ...
    const getCurrentStepIndex = () => {
        if (warranty.status === 'Garantia finalizada') return 3;
            ...
            <div className="max-w-xl mx-auto p-4 sm:p-6 space-y-6">
                <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-200">
                    <div className="flex justify-between items-start mb-6">
                        <div>
                            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Pedido Original</p>
                ...
                {warranty.status === 'rejeitado' ? (
                    ...
                    <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-200">
                        ...
                        <div className="relative space-y-8 ml-3">
                            ...
                            {steps.map((step, idx) => {
                                const isCompleted = idx < currentStep || (idx === 3 && warranty.status === 'Garantia finalizada');
                                const isCurrent = idx === currentStep && warranty.status !== 'Garantia finalizada';
