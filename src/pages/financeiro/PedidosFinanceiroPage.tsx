...
import { Search, Filter, ChevronDown, Eye, CheckCircle, Send, Package, TrendingUp, DollarSign, Clock, Star, Inbox } from 'lucide-react';
                            ...
                            {paginatedOrders.map(order => (
                                <tr key={order.id} className="hover:bg-muted/30 transition-colors">
                                    ...
                                    <td className="text-right">
                                        <button
                                            onClick={() => navigate(`/financeiro?view=${order.id}`)}
