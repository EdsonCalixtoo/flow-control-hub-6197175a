                            ...
                            {(order.observation || order.notes) && (
                                <div className="space-y-4">
                                    ...
                                    <div className="p-4 rounded-2xl bg-amber-500/5 border border-amber-500/20 space-y-3">
                                        {order.observation && (
                                            <div>
                                                <p className="text-[10px] font-black uppercase text-amber-500/60 tracking-widest mb-1">Observação Geral</p>
                                                <p className="text-sm font-semibold text-foreground italic">"{order.observation}"</p>
                                            </div>
                                        )}
                                        {order.notes && (
                                            <div>
                                                <p className="text-[10px] font-black uppercase text-amber-500/60 tracking-widest mb-1">Notas Adicionais</p>
                                                <p className="text-sm font-semibold text-foreground italic">"{order.notes}"</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
